...
/**
 * Tailwind design tokens are driven by CSS variables (see src/styles/index.css)
 * so the same class names resolve to the correct value in light and dark mode.
 */
const config: Config = {
  darkMode: 'class',
